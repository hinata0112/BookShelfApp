...
def search(request):
  ...
  if searchform.is_valid():
     ...
     titles = Shelf.objects.filter(title__icontains=query)    # クエリを含むレコードをfilterメソッドで取り出し、articles変数に代入
     return render(request, 'book/result.html',{'title':titles,'searchform':searchform})